            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                <div class="d-flex">
                    <div class="breadcrumb">
                        ...
                        <router-link class="breadcrumb-item " :to="{ path: '/admin/events'}">
...
export default {
    ...
    methods: {
        get_event() {
            axios.get(
                '/vue/admin/event/'+this.$route.params.id).then((response) => {
                this.loader = false;
        ...
        item_update() {
            ...
            axios.post(
                '/vue/admin/event/'+this.$route.params.id+'/update',
                formData, config).then((response) => {
                this.notify('Success', 'Event Updated successfully', 'fas fa-check p-1');
